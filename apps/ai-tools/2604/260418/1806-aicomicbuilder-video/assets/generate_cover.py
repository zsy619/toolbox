...
OUTPUT_PATH = "/Users/zhushuyan/VideoProjects/aicomicbuilder-video/docs/assets/cover.png"
...
def create_cover():
    ...
    subtitle_text = "AI 漫剧生成器"
    bbox2 = draw.textbbox((0, 0), subtitle_text, font=subtitle_font)
    subtitle_width = bbox2[2] - bbox2[0]
    subtitle_x = (WIDTH - subtitle_width) // 2
    draw.text((subtitle_x, HEIGHT//3 + 110), subtitle_text, font=subtitle_font, fill='#8B5CF6')
    line_y = HEIGHT * 2 // 3
    draw.line([(WIDTH//4, line_y), (WIDTH*3//4, line_y)], fill='#8B5CF6', width=2)
    stat_font = ImageFont.truetype('/System/Library/Fonts/STHeiti Light.ttc', 36)
    stat_text = "从剧本到动画视频，全流程打通"
