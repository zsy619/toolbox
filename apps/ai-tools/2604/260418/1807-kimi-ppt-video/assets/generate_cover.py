...
OUTPUT_PATH = "/Users/zhushuyan/VideoProjects/kimi-ppt-video/docs/assets/cover.png"
...
def create_cover():
    ...
    subtitle_text = "Excel 变麦肯锡级报告"
    bbox2 = draw.textbbox((0, 0), subtitle_text, font=subtitle_font)
    subtitle_width = bbox2[2] - bbox2[0]
    subtitle_x = (WIDTH - subtitle_width) // 2
    draw.text((subtitle_x, HEIGHT//3 + 110), subtitle_text, font=subtitle_font, fill='#10B981')
    line_y = HEIGHT * 2 // 3
