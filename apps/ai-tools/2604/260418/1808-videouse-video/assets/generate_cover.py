...
OUTPUT_PATH = "/Users/zhushuyan/VideoProjects/videouse-video/docs/assets/cover.png"
...
def create_cover():
    ...
    subtitle_text = "Claude Code 专业视频编辑器"
    bbox2 = draw.textbbox((0, 0), subtitle_text, font=subtitle_font)
    subtitle_width = bbox2[2] - bbox2[0]
    draw.text(((WIDTH - subtitle_width)//2, HEIGHT//3 + 110), subtitle_text, font=subtitle_font, fill='#EF4444')
    line_y = HEIGHT * 2 // 3
