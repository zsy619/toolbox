...
OUTPUT_PATH = "/Users/zhushuyan/VideoProjects/design-extract-video/docs/assets/cover.png"
...
def create_cover():
    ...
    subtitle_text = "一行命令逆向设计系统"
    bbox2 = draw.textbbox((0, 0), subtitle_text, font=subtitle_font)
    subtitle_width = bbox2[2] - bbox2[0]
    draw.text(((WIDTH - subtitle_width)//2, HEIGHT//3 + 110), subtitle_text, font=subtitle_font, fill='#6366F1')
    line_y = HEIGHT * 2 // 3
    draw.line([(WIDTH//4, line_y), (WIDTH*3//4, line_y)], fill='#6366F1', width=2)
    stat_font = ImageFont.truetype('/System/Library/Fonts/STHeiti Light.ttc', 36)
    stat_text = "从任何网站提取完整设计语言"
