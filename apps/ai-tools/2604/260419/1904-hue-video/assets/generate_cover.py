...
OUTPUT_PATH = "/Users/zhushuyan/VideoProjects/hue-video/docs/assets/cover.png"
...
def create_cover():
    ...
    subtitle_text = "AI 设计系统生成器"
    bbox2 = draw.textbbox((0, 0), subtitle_text, font=subtitle_font)
    subtitle_width = bbox2[2] - bbox2[0]
    draw.text(((WIDTH - subtitle_width)//2, HEIGHT//3 + 110), subtitle_text, font=subtitle_font, fill='#EC4899')
    line_y = HEIGHT * 2 // 3
    draw.line([(WIDTH//4, line_y), (WIDTH*3//4, line_y)], fill='#EC4899', width=2)
