...
OUTPUT_PATH = "/Users/zhushuyan/VideoProjects/autoresearch-video/docs/assets/cover.png"
...
def create_cover():
    ...
    subtitle_text = "Karpathy 的 AI 自动研究"
